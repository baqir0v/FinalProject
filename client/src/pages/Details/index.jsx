                ...
                <div id='detailpage' className={darkmode ? "darkdetail" : "lightdetail"}>
                    ...
                    <div className={isRateOpen ? "ratewithstars" : "dnone"}>
                        <div className="stars">
                            ...
                            <select className="minimal" value={selectedRating} onChange={(e) => setSelectedRating(e.target.value)}>
                            ...
                            <button className="button-9" role="button" onClick={handleRate}>Rate</button>
                        </div>
                    </div>
                    <Navbar />
                    {details ?
